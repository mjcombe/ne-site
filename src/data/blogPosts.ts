...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "Local SEO is the practice of optimising your online presence so that your business appears in geographically relevant search results. For tradespeople operating in the North East — whether you're covering Newcastle, Gateshead, Sunderland, North Shields or the wider Tyne and Wear area — this is arguably the most important marketing investment you can make.",
      "## Why Local Searches Convert Better",
      "Unlike general web searches, local searches carry strong buying intent. Someone searching 'roofer North Shields' isn't casually browsing — they need a roofer, and they need one soon. Studies show that 76% of people who search for something nearby visit a business within a day, and 28% of those searches result in a purchase.",
      "## Google's Local Pack: The Prime Real Estate",
      "The local pack — that map with three business listings at the top of Google — is where most clicks happen for trade searches. Appearing here means your business name, reviews, phone number and directions are front and centre. To get into this pack, you need a well-optimised Google Business Profile, consistent local citations, and genuine customer reviews.",
      "## What Happens Without Local SEO",
      "Without local SEO, your website might rank for generic terms but miss the customers who are actually ready to hire. You'll rely on word of mouth alone, pay over the odds for lead generation sites that take a cut, and watch newer competitors overtake you simply because they've invested in their online presence.",
      "## Getting Started",
      "The good news is that local SEO for tradespeople doesn't have to be complicated. Start with claiming and verifying your Google Business Profile, ensure your name, address and phone number are consistent across the web, and begin collecting reviews from satisfied customers. These three steps alone can dramatically improve your visibility in local search results across the North East.",
      "If you want to go further, dedicated service area pages, locally-focused content, and technical SEO improvements can help you dominate your patch and keep your diary full year-round."
    ]
  },
  {
    ...
    content: [
      "Your Google Business Profile (GBP) is one of the most powerful free tools available to any tradesperson. It's what shows up when someone searches for your business name, and it's what feeds the map results when people search for trades in their area. Yet most tradespeople either haven't claimed theirs or have barely filled it in.",
      ...
      "Your primary category is crucial. If you're an electrician, select 'Electrician' — not 'Contractor' or 'Handyman'. You can add secondary categories too: 'Electrical installation service', 'Emergency electrician', and so on. The more specific and accurate your categories, the better Google can match you to relevant searches.",
  ...
  },
  {
    ...
    category: "Reviews",
    content: [
      "For tradespeople, reputation is everything. In the past, word of mouth spread through neighbours chatting over fences. Today, it happens through Google reviews. A strong review profile doesn't just build trust — it directly impacts whether your business appears in local search results.",
      "## Why Reviews Matter More Than You Think",
      "Google uses reviews as a ranking signal. Businesses with more reviews and higher ratings tend to appear higher in search results and the local map pack. Beyond rankings, reviews influence the click-through rate — a business with 4.8 stars and 80 reviews will get far more enquiries than one with 3.5 stars and 12 reviews.",
      ...
      "## What Not to Do",
      "Never offer incentives for reviews — this violates Google's policies. Don't ask friends or family to leave fake reviews. Don't review-gate (only asking customers you think will leave positive reviews). Authenticity is paramount, and Google's detection systems are increasingly sophisticated."
    ]
  },
  {
    ...
    category: "Local SEO",
    content: [
      "If you're a plumber based in North Shields but you also cover Whitley Bay, Tynemouth, Wallsend, and Newcastle, you have a problem: Google typically ranks you for the area where your business is physically located. Service area pages solve this by creating dedicated, optimised pages for each location you serve.",
      ...
      "## Why They Work",
      "Each page gives Google a clear signal that you serve that specific area. When someone searches 'plumber Whitley Bay', your dedicated page has a much better chance of ranking than a generic homepage that mentions Whitley Bay in passing. The page can include location-specific content, mention local landmarks or areas, and target the exact search terms people in that area use.",
      ...
      "The biggest mistake is creating thin, duplicate pages where only the town name changes. Google will see through this and may penalise your site. Each page needs unique, valuable content. Another mistake is targeting areas you don't actually serve — this damages trust and wastes everyone's time.",
      "## Linking and Structure",
      "Link your service area pages from your main navigation or a dedicated 'Areas We Cover' section. Internal linking between related pages helps Google understand your site structure. Each page should link back to your main service pages and include your contact details prominently."
    ]
  },
  {
    ...
    category: "Websites",
    content: [
      "Your website is often the first impression a potential customer has of your business. If it's slow, confusing, or looks like it was built in 2010, people will hit the back button and call a competitor instead. Here are the seven most common website mistakes we see tradespeople make.",
      "## 1. No Clear Phone Number",
      "This sounds obvious, but you'd be surprised how many trade websites bury the phone number. It should be visible in the header on every page, clickable on mobile, and prominent in your hero section. A homeowner with a burst pipe doesn't want to hunt for your contact details.",
      ...
      "## 3. No Social Proof",
      "Homeowners are trusting you with their property. They want reassurance. Display your Google reviews prominently, show accreditations (Gas Safe, NICEIC, etc.), and include before-and-after photos of your work. If you have testimonials, use them.",
      "## 4. Slow Loading Speed",
      "A website that takes more than 3 seconds to load will lose nearly half its visitors. Common culprits for trade websites are oversized photos uploaded straight from a phone, cheap hosting, and bloated website builders. Compress your images and invest in decent hosting.",
      "## 5. Generic Content",
      "If your website could belong to any tradesperson in any town, it's not working hard enough. Mention the specific areas you serve, the types of properties you work on, and the specific services you offer. 'We provide a full range of electrical services across Newcastle and Gateshead' is better than 'We do electrics'.",
      ...
      "A beautiful website that nobody can find is useless. At minimum, every page needs a unique title tag and meta description, your content should mention the services and areas you cover naturally, and your site should be submitted to Google Search Console. These basics alone put you ahead of most competitors."
    ]
  },
  {
    ...
    content: [
      ...
      "Over 60% of Google searches now happen on mobile devices, and for local service searches like 'electrician near me' or 'emergency plumber Newcastle', that figure is even higher. Google has adopted mobile-first indexing, meaning it primarily uses the mobile version of your site for ranking and indexing.",
      ...
      "When someone searches on mobile, Google Maps results are even more prominent than on desktop. This makes your Google Business Profile doubly important for mobile users. Ensure your location is accurate, your hours are correct, and you have recent reviews.",
      "## Testing Your Mobile Experience",
      "Pull out your phone and visit your own website. Can you find your phone number in under 2 seconds? Does the page load quickly? Is the text readable without zooming? Can you easily navigate to key information? If the answer to any of these is no, you're losing mobile customers every day."
    ]
  },
  {
    ...
    content: [
      ...
      "With SEO, when someone searches 'electrician North Shields' and finds your website, they're coming directly to you. There's no competition on the same page. They see your reviews, your work, your brand. The enquiry is yours alone, and the trust is already building before they pick up the phone.",
      "## The Cost Comparison",
      ...
      "## Quality of Leads",
      "SEO leads tend to be higher quality because the customer has found you specifically. They've read about your services, seen your reviews, and chosen to contact you — not just clicked a button that sends their details to five strangers. This means higher conversion rates, better margins, and customers who value your work.",
      "## Building a Long-Term Asset",
      "Your website is a business asset that appreciates over time. Every piece of content, every review, every backlink adds value. Lead generation platforms give you nothing lasting — they're a rental model. SEO is ownership. After 12-18 months of consistent SEO work, most tradespeople find they can reduce or eliminate their lead gen spend entirely.",
      "## The Smart Approach",
      "We're not suggesting you ditch lead gen sites overnight. Use them as a bridge while your SEO builds momentum. But shift your budget gradually toward your own online presence. Within a year, you'll have a sustainable source of high-quality, exclusive leads that doesn't depend on a third party."
    ]
  },
  {
    ...
    category: "Websites",
    content: [
      "The days of a basic brochure website being 'good enough' for a trade business are over. In 2026, your website needs to work as your hardest-working salesperson — building trust, answering questions, and converting visitors into enquiries around the clock.",
      "## Speed and Performance",
      "Your website should load in under 2 seconds. This isn't just about user experience — Google uses page speed as a ranking factor. Fast-loading sites rank higher and convert better. This means optimised images, clean code, and quality hosting. If your site takes more than 3 seconds to load, you're losing nearly half your visitors.",
      "## Trust Signals Front and Centre",
      "Trade customers are letting strangers into their homes. They need reassurance. Your website should prominently display Google reviews, industry accreditations (Gas Safe, NICEIC, FENSA, etc.), insurance details, and examples of completed work. These trust signals should be visible without scrolling on your homepage.",
      "## Clear Service Pages",
      ...
      "## Local Focus",
      "Your website should make it immediately clear where you operate. Service area pages for your key locations, mentions of local areas throughout your content, and embedded Google Maps all help both users and search engines understand your service area.",
      ...
      "## Mobile-First Design",
      "With over 60% of trade searches happening on mobile, your website must work flawlessly on phones. Large tap targets, clickable phone numbers, readable text without zooming, and fast load times on mobile networks are non-negotiable.",
      "## Ongoing Content",
      "A website that hasn't been updated in two years signals a business that might not still be trading. Regular blog posts, new project photos, and updated service information keep your site fresh for both visitors and search engines. Even one quality blog post per month makes a significant difference to your search visibility."
    ]
  },
  {
    ...
    content: [
      ...
      "Start with the essentials: Google Business Profile, Bing Places, Apple Maps, Yell.com, Thomson Local, and FreeIndex. Then add industry-specific directories relevant to your trade — Checkatrade, TrustATrader, MyBuilder, and RatedPeople. For North East businesses specifically, directories like NE1 Trades and local chamber of commerce listings add valuable local signals.",
      ...
      "Don't try to submit to 100 directories in one day. Build citations gradually and naturally over time. Focus on high-quality, relevant directories first. Each listing should be fully completed — fill in every field, add your website URL, write a unique description, and upload your logo where possible.",
      "## North East Specific Opportunities",
      "Look for local directories and listings specific to the North East. Local council websites sometimes have trade directories, community websites may list local services, and regional news sites sometimes offer business listings. These hyper-local citations carry extra weight for ranking in North East search results."
    ]
  },
  {
    ...
    content: [
      ...
      "This is the foundation. Complete every section of your profile — business name, categories, description, services, hours, service area, attributes, and photos. The more complete your profile, the more signals Google has to determine your relevance. Update your profile regularly with new photos and posts.",
      "## Reviews: Quality, Quantity, and Recency",
      "Reviews are the biggest prominence signal for map pack rankings. You need a high volume of reviews, a high average rating, and recent reviews. A business with 5 reviews from 2023 will be outranked by one with 50 reviews from the past year. Make asking for reviews a standard part of your job completion process.",
      ...
      "Consistent business listings across directories support your map pack ranking. Ensure your NAP (name, address, phone) is identical everywhere. Focus on quality directories relevant to your trade and your area.",
      "## Your Website Matters Too",
      "While the map pack is driven primarily by your Google Business Profile, your website plays a supporting role. A well-optimised website with local content, proper schema markup, and strong technical SEO sends additional signals that boost your map pack position. Link your GBP to your website and ensure the information matches exactly.",
      "## Engagement Signals",
