...
const ServiceAreaPages = () => (
  <ServicePageLayout
    ...
    description="Dedicated pages for every town and area you cover. When someone searches for your services in a specific location, your business shows up with a page built for that exact search."
    whoIsItFor={[
      "Businesses that cover multiple towns or areas",
      "Companies wanting to rank in specific locations they serve",
      "Growing businesses expanding into new areas",
      "Any local business that wants to dominate searches across their service area",
    ]}
    howItHelps={[
      "Each service area page targets location-specific searches, so when a customer in Gateshead, Durham, or Sunderland searches for your services, they find a page specifically about what you offer in their area.",
      "Google rewards relevance. A dedicated page about your services in Newcastle is far more likely to rank than a generic homepage trying to cover everything.",
