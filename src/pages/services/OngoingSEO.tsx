...
const OngoingSEO = () => (
  <ServicePageLayout
    ...
    description="SEO isn't a one-off job. We provide continuous optimisation, fresh content, and performance tracking to make sure your business keeps ranking higher and generating more enquiries month after month."
    whoIsItFor={[
      "Businesses already ranking that want to maintain and improve positions",
      "Companies that want consistent growth in online enquiries",
      "Businesses in competitive local markets where rankings fluctuate",
      "Any business that sees the value in long-term investment in visibility",
    ]}
    howItHelps={[
      "Google's algorithms change constantly. Ongoing SEO means your website adapts to these changes and stays competitive.",
      "We publish fresh, relevant content that targets new search terms and reinforces your authority in your industry.",
      "Monthly performance tracking lets you see exactly how your rankings, traffic, and enquiries are improving over time.",
      "Competitor monitoring ensures you stay ahead of other local businesses fighting for the same customers.",
    ]}
    whatsIncluded={[
