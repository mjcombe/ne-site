...
const WebsitesForTrades = () => (
  <ServicePageLayout
    ...
    subtitle="Websites for Businesses"
    description="Your website is your shopfront. We build clean, professional websites that make businesses look credible and convert visitors into phone calls, enquiries, and bookings."
    whoIsItFor={[
      "Business owners who need their first professional website",
      "Companies with an outdated site that isn't generating enquiries",
      "Growing businesses who want a website that matches their reputation",
      "Any business that wants more calls and leads from their website",
    ]}
    howItHelps={[
      "A professional website builds instant trust with potential customers. When someone searches for a local business, your website is the first impression they get.",
    ...
    expectedOutcomes={[
      ...
      "More phone calls and enquiries from your website every month.",
