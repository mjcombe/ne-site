...
const AISEO = () => (
  <ServicePageLayout
    ...
    description="The future of search is changing. AI-driven search results, voice assistants, and generative engines are reshaping how customers find businesses. We make sure your business is optimised for both traditional and AI-powered search."
    whoIsItFor={[
      "Businesses that want to future-proof their online presence",
      "Companies that want to appear in AI-generated search answers",
      "Businesses looking to get ahead of competitors who haven't adapted yet",
      "Any business that wants to maximise visibility across all search platforms",
    ]}
    howItHelps={[
      ...
      "Voice search optimisation ensures your business is found when customers ask Siri, Alexa, or Google Assistant for a local business.",
    ]}
    whatsIncluded={[
